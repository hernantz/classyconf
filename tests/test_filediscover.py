...
from classyconf.exceptions import InvalidPath
...
def test_should_not_look_for_parent_directory_when_it_finds_valid_configurations(
    files_path,
):
...
def test_should_look_for_parent_directory_when_it_finds_invalid_configurations(
    files_path,
):
